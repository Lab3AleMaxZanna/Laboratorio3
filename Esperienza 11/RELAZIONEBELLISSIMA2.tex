...
\end{figure}
I led si accendono in sequenza, partendo dal primo e scorrendo fino all'ultimo, l'accensione di uno sfasata di un periodo di clock rispetto all'accensione del successivo. Il primo segue il DIP switch, con un ritardo di al massimo un periodo di clock.
